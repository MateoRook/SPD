    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                // parametr u
                double[] u = { 0.4, 0.8, 0.9, 0.95, 0.99 };
                int[] best = { 0, 0, 0, 0, 0 };
                using (StreamWriter swr = new StreamWriter(resultFileName2))
                {
                    swr.WriteLine("indeks \t 0.4 \t 0.8 \t 0.9 \t 0.95 \t 0.99 \t NEHacc");
                ...
                // parametr T0
                //double[] T0 = { 40, 80, 160, 320, 640 };
                //int[] best = { 0, 0, 0, 0, 0 };
                //using (StreamWriter swr = new StreamWriter(resultFileName3))
                //{
                //    swr.WriteLine("indeks \t 40 \t 80 \t 160 \t 320 \t 640 \t NEHacc");
